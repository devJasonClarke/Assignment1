...
function createVideo(src, width, controls) {
  ...
  if (controls === true) {
    if (width < 1) {
      fullString = '<video src="' + str + '" controls></video>';
    } else {
      fullString = '<video src="' + str + '" width="' + width + '" controls></video>';
    }
  } else {
    if (width < 1) {
      fullString = '<video src="' + str + '"></video>';
    } else {
      fullString = '<video src="' + str + '" width="' + width + '"></video>';
    }
  }
  return fullString;
}
